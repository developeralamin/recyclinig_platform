          ...
          <div class="a6 a1K ac">
            <div class="a5 md:a2u/2 af">
              <div class="a3u">
                ...
                <input type="text" name="name" placeholder="Enter your  name" class="a5 a25 a1i aT av[14px] a3X aw a2C a4v dark:a4w aK dark:a1 a2E a4x focus-visible:aN focus:a2F @error('name') is-invalid @enderror" />
            ...
            <div class="a5 md:a2u/2 af">
              <div class="a3u">
                ...
                <input type="text" name="mobile" placeholder="Enter your phone number" class="a5 a25 a1i aT av[14px] a3X aw a2C a4v dark:a4w aK dark:a1 a2E a4x focus-visible:aN focus:a2F" class="form-control {{ $errors->has('mobile') ? 'error' : '' }}" />
                <font style="color: red">
      ...
      <div>
        <span class="ao a2K a4z a2i">
          <svg width="126" height="156" viewBox="0 0 126 156" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M62.9999 126C97.8032 126 126 97.7947 126 63C126 28.2053 97.8032 0 62.9999 0C28.2137 0 -6.10352e-05 28.2053 -6.10352e-05 63C-6.10352e-05 97.7947 28.2137 126 62.9999 126Z" fill="url(#paint0_radial_100_549)" />
        ...
        <span class="ao a4A a4B a2i">
          <svg width="161" height="189" viewBox="0 0 161 189" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M160.578 80.5879C160.578 36.3933 124.762 0.587885 80.5784 0.587887C36.3946 0.587889 0.578432 36.3933 0.578434 80.5879C0.578436 124.761 36.3947 160.588 80.5784 160.588C124.762 160.588 160.578 124.761 160.578 80.5879Z" fill="url(#paint0_radial_100_548)" />
